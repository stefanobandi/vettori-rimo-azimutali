...
with col_c:
    ...
    # --- SCALA VETTORI AGGIORNATA (Vettori molto più lunghi) ---
    sc = 1.5
    ...
    # --- LIMITI GRAFICO ESPANSI PER VETTORI LUNGHI ---
    ax.set_xlim(-65, 65); ax.set_ylim(-100, 80); ax.set_aspect('equal'); ax.axis('off')
    st.pyplot(fig)
