...
st.set_page_config(page_title="ASD Centurion V5.2.1", layout="wide")
...
# --- NUOVE FUNZIONI DI RESET SEPARATE ---
def reset_engines():
...
# --- SIDEBAR (Modificata con 2 bottoni) ---
with st.sidebar:
    ...
    # Bottone 2: Pivot Point
    st.button("Reset Pivot Point", on_click=reset_pivot, use_container_width=True)
    
    st.info("Usa i tasti sopra per resettare separatamente i propulsori o la posizione del Pivot Point.")

# --- CALCOLI FISICI (Identici all'originale) ---
